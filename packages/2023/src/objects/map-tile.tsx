...
import floorTileFragmentShader from '../data/shaders/floor-tile.frag.glsl'
import floorTileVertexShader from '../data/shaders/floor-tile.vert.glsl'
import wallTileFragmentShader from '../data/shaders/wall-tile.frag.glsl'
import wallTileVertexShader from '../data/shaders/wall-tile.vert.glsl'
